...
tempBarButton.place(x=75, y= 450)
...
rainBarButton.place(x=930, y= 450)
...
multiBarButton.place(x=1130, y= 450)
...
scatterTempButton.place(x=275, y= 450)
...
scatterRainButton.place(x=500, y= 450)
...
scatterButton.place(x=715, y= 450)
...
boxPlotButton.place(x=1325, y= 450)
